  ...
  <view class="container">
    <view class="page-body uni-content-info">
      ...
      <view class="cropper-config">
        <button type="primary reverse" @click="getImage" style="margin-top: 30rpx">
          选择头像
        </button>
  ...
  methods: {
    ...
    getImageInfo() {
      ...
      ctx.draw(true, () => {
        ...
        var canvasW =
          ((_this.cropperW - _this.cutL - _this.cutR) / _this.cropperW) * IMG_REAL_W;
        var canvasH =
          ((_this.cropperH - _this.cutT - _this.cutB) / _this.cropperH) * IMG_REAL_H;
